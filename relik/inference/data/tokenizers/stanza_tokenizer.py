...
from sapienzanlp.data import Word
from sapienzanlp.preprocessing.tokenizers.tokenizer import Tokenizer
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Example::
            ...
            >>> from sapienzanlp.preprocessing import StanzaTokenizer
